...
class RegionInvokeApi(RegionApiBaseHttpClient):
    ...
    def api_gateway_bind_tcp_domain(self, region, tenant_name, k8s_service_name, container_port, app_id, ingressPort=None,service_id="",service_type=""):
        """
        ...
        path = "/v2/proxy-pass/gateway/" + tenant_name + "/routes/tcp?appID=" + str(app_id) + "&service_id="+service_id +"&service_type="+service_type
