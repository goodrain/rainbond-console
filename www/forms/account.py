    ...
    def __init__(self, *args, **kwargs):
        ...
        if settings.MODULES["WeChat_Module"]:
            self.helper.layout = Layout(
                Div(
                    Field('tenant', "", placeholder='请输入团队名', css_class="form-control") if tenant_name is None else Field('tenant', "", placeholder='请输入团队名', css_class="form-control", readonly="readonly", value=tenant_name),
