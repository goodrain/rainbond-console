...
class ServiceDomain(BaseModel):
    ...
    rule_name = models.CharField(max_length=32, null=True, default=None, blank=True, help_text=u"DNS服务厂商")
...
class TenantServiceVolume(BaseModel):
    ...
    allow_expansion = models.BooleanField(max_length=100, null=True, default=0, blank=True, help_text=u"只是支持控制扩展，0：不支持；1：支持")
