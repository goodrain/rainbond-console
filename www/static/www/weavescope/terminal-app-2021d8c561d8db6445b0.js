  ...
  if (window.parent && window.parent.weavescope) {
    ...
    doRequest({
      ...
      error: function error() {
        ...
        if (tiem < 5) {
          var _scopeData2 = goodrainData2scopeData(tiem % 2 == 0 ? datas : data);
          dispatch((0, _appActions.receiveNodesDelta)(_scopeData2));
        }
...
function renderApp() {
  var TerminalApp = __webpack_require__(898).default;
