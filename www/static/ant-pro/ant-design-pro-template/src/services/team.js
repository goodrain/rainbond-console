...
/*
	团队下用户的信息
*/
export async function userDetail(body={team_name, user_name}) {
...
/*
	移交团队管理权限
*/
export async function moveTeam(body={team_name, user_name}) {
...
/*
	修改成员权限
*/
export async function editMemberPermission(body={team_name, user_name, identitys}){
...
/*
   新建团队
*/
export async function createTeam(body={team_name, useable_regions:[]}){
...
/*
	获取团队下的所有成员
*/
export async function getMembers(body={team_name, pageNumber, pageSize}){
...
/*
	添加成员
*/
export async function addMember(body={team_name, user_ids, identity}){
...
/*
    删除成员
*/
export async function removeMember(body={team_name, user_ids}){
...
/*
	修改团队名称
*/
export async function editTeamName(body={team_name, new_team_alias}) {
...
/*
	删除团队
*/
export async function deleteTeam(body={team_name}){
...
/*
	获取团队下的数据中心
*/
export async function getRegions(body={team_name}){
...
/*
   总览团队在某个数据中心下的信息
*/
export async function getTeamRegionOverview(body={team_name, region_name}){
...
*/
export async function getTeamRegionAppsStatus(body={team_name, region_name, service_ids}) {
...
/*
	获取团队在某个数据中心下的所有应用组
*/
export async function getTeamRegionGroups(body={team_name}){
...
/*
   获取团队下的证书
*/
export async function getCertificates(body={team_name}) {
...
/*
  添加证书
*/
export async function addCertificate(body={team_name, alias, private_key, certificate}) {
  return request(config.baseUrl + `/console/teams/${body.team_name}/certificates`, {
    method: 'post',
    data:{
        alias: body.alias,
...
/*
  获取团队下最新操作动态
*/
export async function getNewestEvent(body={team_name, page, page_size}) {
...
/*
  获取团队未开通的数据中心列表
*/
export function unOpenRegion(body={team_name}){
...
/* 开通数据中心 */
export function openRegion(body={team_name, region_names}){
...
*/
export function getGithubInfo(body={team_name}){
...
/*
  获取团队授权绑定的gitlub信息
*/
export function getGitlabInfo(body={team_name}){
...
/*
  获取数据中心的key
*/
export async function getRegionKey(body={team_name, region_name}) {
  return request(config.baseUrl + `/console/teams/${body.team_name}/regions/${body.region_name}/publickey`, {
    method: 'get'
  });
}
