...
export const getRouterData = (app) => {
  const routerConfig = {
    '/': {
      component: dynamicWrapper(app, ['user', 'appControl', 'createApp', 'teamControl', 'plugin'], () => import('../layouts/BasicLayout')),
    },
    '/index': {
    ...
    '/app/:appAlias/:type?': {
      component: dynamicWrapper(app, ['appDetail', 'appControl'], () => import('../routes/App/index')),
    },
    '/create/code/:type?': {
