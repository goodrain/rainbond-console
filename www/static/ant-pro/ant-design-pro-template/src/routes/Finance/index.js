      ...
      <PageHeaderLayout>
        <div className={styles.standardList}>
          ...
          <div style={{textAlign: 'right', paddingTop: 24}}>
            ...
            <Button.Group>
            {(regionId && !entId) && <Button type="primary"><a target="_blank" href={`https://frontend-test.goodrain.com/spa/#/resBuy/${regionId}`}>购买资源</a></Button>}
            {(entId && regionId)&& <Button type="primary"><a target="_blank" href={`https://frontend-test.goodrain.com/spa/#/resBuy/${regionId}/${entId}`}>购买资源</a></Button>}
