...
class RainbondPluginService(object):
    def list_plugins(self, enterprise_id, region_name):
        namespaces, team_ids, region_app_ids, app_ids, component_ids = [], [], [], [], []
        ...
        teams = team_services.list_by_namespaces(namespaces)
        for team in teams:
            team_map = {team.tenant_name: team.tenant_name}
        ...
        for plugin in plugins:
            ...
            plugin["team_name"] = team_map.get(plugin["namespace"], "")
