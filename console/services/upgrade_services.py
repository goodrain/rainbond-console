...
class UpgradeService(object):
    ...
    @transaction.atomic()
    def openapi_upgrade_app_models(self, user, team, region_name, app_id, data):
        ...
        for update_version in update_versions:
            ...
            upgrade_service.send_upgrade_request(market_services, team, user, app_record, upgrade_info)
