...
class AppVersionService(object):
    ...
    @staticmethod
    def _build_collision_safe_hidden_template_id(app_id: Any, index: Optional[int] = 0) -> str:
    ...
    def _is_hidden_template_app(self, app: Any, source_app_id: Any) -> bool:
        if not app:
            return False
        return bool(
    ...
    def _resolve_hidden_template_app(self, app: ServiceGroup) -> Tuple[Any, Any]:
    ...
    def _move_snapshot_versions_to_hidden_template(self, source_app_id: Any, target_app_id: Any,
                                                   app_id: Any) -> None:
    ...
    def _repair_hidden_template_relation(self, relation: Any, hidden_app_id: Any, hidden_app_name: str,
                                         source_app_id: Any, app_id: Any) -> Any:
    ...
    def get_or_create_hidden_template(self, tenant: Tenants, user: Users, app: ServiceGroup) -> Tuple[Any, Any]:
        ...
        if relation and hidden_app and self._is_hidden_template_app(hidden_app, app.ID):  # type: ignore[arg-type]
