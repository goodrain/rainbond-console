...
class AppEnvVarService(object):
    ...
    def add_service_env_var(self,
                            ...
                            scope="outer",
                            user_name=''):
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] add_service_env_var request tenant=%s service_alias=%s service_id=%s create_status=%s scope=%s name=%s attr_name=%s attr_value=%s is_change=%s",
        ...
        if env:
            logger.error("[PURCHASE_ENV_CONSOLE_RAW] add_service_env_var existing env tenant=%s service_alias=%s service_id=%s attr_name=%s existing_env=%s",
        ...
        if service.create_status == "complete":
            ...
            logger.error("[PURCHASE_ENV_CONSOLE_RAW] add_service_env_var sync region request tenant=%s service_alias=%s service_id=%s region=%s body=%s",
        ...
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] add_service_env_var created env tenant=%s service_alias=%s service_id=%s env=%s",
    ...
    def update_env_by_env_id(self, tenant, service, env_id, name, attr_value, user_name=''):
        ...
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_env_by_env_id request tenant=%s service_alias=%s service_id=%s env_id=%s old_env=%s new_name=%s new_value=%s",
        ...
        if service.create_status == "complete":
            ...
            logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_env_by_env_id sync region request tenant=%s service_alias=%s service_id=%s region=%s body=%s",
                         tenant.tenant_name, service.service_alias, service.service_id, service.service_region,
        ...
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_env_by_env_id success tenant=%s service_alias=%s service_id=%s updated_env=%s",
    ...
    def update_or_create_envs(self, team, service, envs):
        ...
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_or_create_envs request tenant=%s service_alias=%s service_id=%s incoming_envs=%s existing_envs=%s",
        ...
        for env in envs:
            if env["name"] in list(env_attr_names.keys()):
                logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_or_create_envs choose update tenant=%s service_alias=%s service_id=%s env_name=%s env_id=%s",
                ...
                logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_or_create_envs choose create tenant=%s service_alias=%s service_id=%s env_name=%s",
        ...
        logger.error("[PURCHASE_ENV_CONSOLE_RAW] update_or_create_envs result tenant=%s service_alias=%s service_id=%s total_envs=%s",
