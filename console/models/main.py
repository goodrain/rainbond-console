...
class OAuthServices(BaseModel):
    ...
    enable = models.BooleanField(null=True, default=True, help_text="user_id")
    is_deleted = models.BooleanField(null=True, default=False, help_text="is_deleted")
    is_console = models.BooleanField(null=True, default=False, help_text="is_console")
    is_auto_login = models.BooleanField(null=True, default=False, help_text="is_auto_login")
...
class UserOAuthServices(BaseModel):
    ...
    is_auto_login = models.BooleanField(null=True, default=False, help_text="is_auto_login")
    is_authenticated = models.BooleanField(null=True, default=False, help_text="is_authenticated")
    is_expired = models.BooleanField(null=True, default=False, help_text="is_expired")
    access_token = models.CharField(max_length=2047, null=True, help_text="access_token_url")
    refresh_token = models.TextField(null=True, help_text="refresh_token")
