...
class RainbondCenterApp(BaseModel):
    ...
    template_version = models.CharField(
        max_length=10, default="v2", help_text=u"模板版本")
    ...
    enterprise_id = models.CharField(
        max_length=32, default="public", help_text=u"企业ID")
...
class RainbondCenterAppInherit(BaseModel):
    ...
    version = models.CharField(
        max_length=20, unique=True, help_text=u"当前应用版本号")
    derived_group_key = models.CharField(
        max_length=32, unique=True, help_text=u"继承哪个云市应用")
...
class RainbondCenterPlugin(BaseModel):
    ...
    create_time = models.DateTimeField(
        auto_now_add=True, null=True, blank=True, help_text=u"创建时间")
    update_time = models.DateTimeField(
        auto_now=True, blank=True, null=True, help_text=u"更新时间")
    enterprise_id = models.CharField(
        max_length=32, default='public', help_text=u"企业id")
...
class ServiceShareRecord(BaseModel):
    ...
    group_share_id = models.CharField(
        max_length=32, unique=True, help_text=u"发布应用组或插件的唯一Key")
    ...
    event_id = models.CharField(
        max_length=32, help_text=u"介质同步事件ID,弃用，使用表service_share_record_event")
...
class ServiceShareRecordEvent(BaseModel):
    ...
    region_share_id = models.CharField(
        max_length=36, help_text=u"应用数据中心分享反馈ID")
    team_name = models.CharField(max_length=32, help_text=u"应用所在团队唯一名称")
    ...
    event_id = models.CharField(
        max_length=32, default="", help_text=u"介质同步事件ID")
    event_status = models.CharField(
        max_length=32, default="not_start", help_text=u"事件状态")
    create_time = models.DateTimeField(auto_now_add=True, help_text=u"创建时间")
    update_time = models.DateTimeField(auto_now_add=True, help_text=u"更新时间")
...
class ServiceSourceInfo(BaseModel):
    ...
    group_key = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="group of service from market")
    version = models.CharField(
        max_length=32,
        null=True,
        blank=True,
        help_text="version of service from market")
...
class TenantUserPermission(BaseModel):
    ...
    group = models.IntegerField(
        help_text=u'这个权限属于哪个权限组', null=True, blank=True)
    per_explanation = models.CharField(
        max_length=132, null=True, blank=True, help_text=u'这一条权限操作的具体说明')
...
class UserMessage(BaseModel):
    ...
    create_time = models.DateTimeField(
        auto_now=True, null=True, blank=True, help_text=u"创建时间")
    update_time = models.DateTimeField(
        auto_now=True, null=True, blank=True, help_text=u"更新时间")
    msg_type = models.CharField(max_length=32, help_text=u"消息类型")
    announcement_id = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"公告ID")
    title = models.CharField(
        max_length=64, help_text=u"消息标题", default=u"title")
...
class GroupAppBackupRecord(BaseModel):
    ...
    event_id = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"事件id")
    group_uuid = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"group UUID")
    version = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"备份版本")
    ...
    backup_server_info = models.CharField(
        max_length=400, null=True, blank=True, default="", help_text=u"备份服务信息")
    source_type = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"源类型")
...
class GroupAppMigrateRecord(BaseModel):
    ...
    group_uuid = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"group UUID")
    version = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"迁移的版本")
    backup_id = models.CharField(
        max_length=36, null=True, blank=True, help_text=u"备份ID")
    ...
    restore_id = models.CharField(
        max_length=36, null=True, blank=True, help_text=u"恢复ID")
    create_time = models.DateTimeField(
        auto_now_add=True, null=True, blank=True, help_text=u"创建时间")
    original_group_id = models.IntegerField(help_text=u"原始组ID")
    original_group_uuid = models.CharField(
        max_length=32, null=True, blank=True, help_text=u"原始group UUID")
...
class Applicants(BaseModel):
    ...
    apply_time = models.DateTimeField(
        auto_now_add=True, null=True, blank=True, help_text=u"申请时间")
    # is_pass是否通过
    is_pass = models.IntegerField(
        default=0, help_text=u'0表示审核中，1表示通过审核，2表示审核未通过')
    # 团队名
