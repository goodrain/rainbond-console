...
class ComposeGroup(BaseModel):
    ...
    create_status = models.CharField(
        max_length=15, null=True, blank=True, help_text=u"compose组创建状态 creating|checking|checked|complete")
...
class UserOAuthServices(BaseModel):
    ...
    is_auto_login = models.BooleanField(null=True, default=False, help_text=u"is_auto_login")
    is_authenticated = models.BooleanField(null=True, default=False, help_text=u"is_authenticated")
    is_expired = models.BooleanField(null=True, default=False, help_text=u"is_expired")
