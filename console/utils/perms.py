...
APP = {
    ...
    "app_overview": {
        "perms": [
            ...
            ["telescopic", "组件伸缩管理", 300011],
            ["create", "组件创建", 300013],
            ["env", "组件环境管理", 300016],
            ["rely", "组件依赖管理", 300017],
            ["storage", "组件存储管理", 300018],
            ["port", "组件端口管理", 300019],
            ["plugin", "组件插件管理", 300020],
            ["source", "组件构建源管理", 300021],
            ["deploy_type", "组件部署类型", 300022],
            ["characteristic", "组件特性", 300023],
            ["health", "组件健康检测", 300024],
            ["service_monitor", "组件业务监控管理", 300025],
            ["maven_setting", "组件Maven配置管理", 300026],
            ["safety", "安全", 300027],
        ]
    },
    "app_release": {
