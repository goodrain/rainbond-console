...
class VMExportServiceTests(TestCase):
    ...
    def test_start_vm_export_uses_direct_export_when_vm_closed(self):
        ...
        self.assertEqual("service-a", export_request["name"])
        ...
        self.assertEqual("Windows 测试机", asset["display_name"])
    ...
    def test_start_vm_export_creates_machine_asset_and_disk_records(self):
        ...
        self.assertEqual("service-a", asset["build_event_id"])
    ...
    def test_sync_vm_export_status_updates_parent_and_disks(self):
        ...
        self.assertEqual("https://download/rootdisk", asset["image_url"])

    def test_delete_vm_image_removes_live_vm_export_resource(self):
        parent = VirtualMachineImage.objects.create(
            tenant_id="tenant-a",
            name="service-a",
            image_url="",
        ...
        with mock.patch("console.services.virtual_machine.region_api.delete_vm_export") as delete_mock:
            deleted, _ = vms.delete_vm_image("tenant-a", parent.ID, region_name="demo-region", tenant_name="demo-team")
