...
urlpatterns = [
    ...
    # helm install openapi
    url(r'^enterprise/helmtoken$', HelmTokenView.as_view()),
    url(r'^enterprise/regioninfo$', HelmAddReginInfo.as_view()),
    url(r'^enterprise/helmStatus$', HelmInstallStatus.as_view()),
