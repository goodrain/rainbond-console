...
from console.views.region import (GetRegionPublicKeyView, OpenRegionView, QyeryRegionView, RegQuyView,
                                  RegUnopenView)
...
from console.views.team import (
    ...
    RegisterStatusView, TeamDelView, TeamExitView, TeamNameModView, TeamRegionInitView,
    TeamSortDomainQueryView, TeamSortServiceQueryView, TeamUserCanJoin, TeamUserDetaislView,
    TeamUserView, UserApplyStatusView, UserDelView, UserFuzSerView)
