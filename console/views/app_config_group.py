...
class AppConfigGroupCommonOperationView(RegionTenantHeaderView, CloudEnterpriseCenterView):
    def post(self, request, *args, **kwargs):
        ...
        for sid in req_service_ids:
            if sid not in service_ids:
                result = general_message(404,
                                         "The serviceID is not in the serviceID of the current application binding",
        ...
        acg = app_config_group.create_config_group(group_id, config_group_name, config_items, deploy_type,
                                                   deploy_status, req_service_ids, region_name)
