...
class EnterpriseConfigView(EnterpriseAdminView):
    ...
    def put(self, request, enterprise_id, *args, **kwargs):
        ...
        security_restrictions = parse_item(request, "security_restrictions")
        ...
        if security_restrictions:
            config_service.update_config_value(ConfigKeyEnum.SECURITY_RESTRICTIONS.name, security_restrictions)
