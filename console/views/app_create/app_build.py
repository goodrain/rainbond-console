...
from console.exception.main import (ErrInsufficientResource,
                                    ServiceHandleException)
from console.repositories.deploy_repo import deploy_repo
from console.services.app import app_service
from console.services.app_actions import app_manage_service, event_service
from console.services.app_config import (dependency_service, env_var_service,
            ...
            if is_deploy:
                try:
                    ...
                    if edge_node:
                        ...
                        # 查询所选边缘节点的污点
                        res, body = region_api.get_node_taints(
                            self.region.region_name, edge_node)
                        # 容忍边缘节点的所有污点
                        if body["list"]:
                            ...
                            k8s_attribute_service.create_k8s_attribute(
                                ...
                                self.region.region_name, attribute)
                        # 新增nodeSelector
