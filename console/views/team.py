...
class TenantUserView(BaseAPIView):
    ...
    def post(self, request, tenant_name, *args, **kwargs):
        ...
        try:
            ...
            is_pass, msg = user_services.check_params(user_name,phone,email,password,re_password)
            if not is_pass:
            ...
            user = user_services.enter_create_user(user_name, phone, email, password, "backend", enterprise, client_ip)
