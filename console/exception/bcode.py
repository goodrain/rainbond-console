...
class ErrUnSupportEnterpriseOauth(ServiceHandleException):
    def __init__(self):
        super(ErrUnSupportEnterpriseOauth, self).__init__("Unsupported enterprise Oauth service",
                                                          msg_show="不支持的企业Oauth服务",
                                                          status_code=400,
                                                          error_code=20301)
...
class ErrUnAuthnOauthService(ServiceHandleException):
    def __init__(self):
        super(ErrUnAuthnOauthService, self).__init__("Unauthenticated oauth service",
                                                     msg_show="该Oauth服务未认证，请认证后重试",
                                                     status_code=400,
                                                     error_code=20302)
...
class ErrExpiredAuthnOauthService(ServiceHandleException):
    def __init__(self):
        super(ErrExpiredAuthnOauthService, self).__init__("oauth authentication information has expired",
                                                          msg_show="该Oauth服务认证信息已过期，请重新认证",
                                                          status_code=400,
                                                          error_code=20303)
...
class ErrOauthUserNotLogout(ServiceHandleException):
    def __init__(self):
        super(ErrOauthUserNotLogout, self).__init__("the oauth user is not logged out",
                                                    msg_show="Oauth 用户尚未退出登录",
                                                    status_code=409,
                                                    error_code=20304)
...
class ErrOauthUserNotFound(ServiceHandleException):
    def __init__(self):
        super(ErrOauthUserNotFound, self).__init__("the oauth user is not found",
                                                   msg_show="Oauth 用户不存在",
                                                   status_code=404,
                                                   error_code=20305)
...
class ErrOauthServiceNotFound(ServiceHandleException):
    def __init__(self):
        super(ErrOauthServiceNotFound, self).__init__("oauth service is not found",
                                                      msg_show="OAuth 服务不存在",
                                                      status_code=404,
                                                      error_code=20306)
...
class ErrNamespaceExists(ServiceHandleException):
    def __init__(self):
        super(ErrNamespaceExists, self).__init__(msg="namespace exists",
                                                 msg_show="团队英文名(命名空间)已存在",
                                                 status_code=400,
                                                 error_code=20701)
...
class ErrComponentBuildFailed(ServiceHandleException):
    def __init__(self):
        super(ErrComponentBuildFailed, self).__init__(msg="failed to build component",
                                                      msg_show="组件构建失败",
                                                      status_code=400,
                                                      error_code=20800)
...
class ErrThirdComponentStartFailed(ServiceHandleException):
    def __init__(self):
        super(ErrThirdComponentStartFailed, self).__init__(msg="failed to start third component",
                                                           msg_show="启动第三方组件失败, 请稍后重试",
                                                           status_code=400,
                                                           error_code=20801)
...
class ErrK8sComponentNameExists(ServiceHandleException):
    def __init__(self):
        super(ErrK8sComponentNameExists, self).__init__(msg="k8s component name exists",
                                                        msg_show="组件英文名已存在",
                                                        status_code=400,
                                                        error_code=20802)
...
class ErrVMImageNameExists(ServiceHandleException):
    def __init__(self):
        super(ErrVMImageNameExists, self).__init__(msg="vm image name exists",
                                                   msg_show="镜像名称已存在，请检查已有镜像",
                                                   status_code=400,
                                                   error_code=20802)
...
class ErrAppUpgradeRecordNotFound(ServiceHandleException):
    def __init__(self):
        super(ErrAppUpgradeRecordNotFound, self).__init__(msg="app upgrade record not found",
                                                          msg_show="找不到升级记录",
                                                          status_code=404,
                                                          error_code=20900)
...
class ErrAppSnapshotNotFound(ServiceHandleException):
    def __init__(self):
        super(ErrAppSnapshotNotFound, self).__init__(msg="app snapshot not found",
                                                     msg_show="找不到应用升级快照",
                                                     status_code=404,
                                                     error_code=20901)
...
class ErrAppSnapshotExists(ServiceHandleException):
    def __init__(self):
        super(ErrAppSnapshotExists, self).__init__(msg="app snapshot exists",
                                                   msg_show="应用升级快照已存在",
                                                   status_code=409,
                                                   error_code=20902)
...
class ErrAppUpgradeDeployFailed(ServiceHandleException):
    def __init__(self, msg=""):
        super(ErrAppUpgradeDeployFailed, self).__init__(msg if msg else "failed to deploy the app, please retry later",
...
class ErrComponentGroupNotFound(ServiceHandleException):
    def __init__(self):
        super(ErrComponentGroupNotFound, self).__init__("component group not found",
                                                        msg_show="无法找到组件与应用市场应用的从属关系",
                                                        status_code=404,
                                                        error_code=20904)
...
class ErrLastRecordUnfinished(ServiceHandleException):
    def __init__(self):
        super(ErrLastRecordUnfinished, self).__init__("the last record is unfinished",
                                                      msg_show="上一个任务未完成",
                                                      status_code=400,
                                                      error_code=20905)
...
class ErrAppUpgradeRecordCanNotDeploy(ServiceHandleException):
    def __init__(self):
        super(ErrAppUpgradeRecordCanNotDeploy, self).__init__("can not deploy the record",
                                                              msg_show="无法重新部署该记录",
                                                              status_code=400,
                                                              error_code=20906)
...
class ErrAppUpgradeRecordCanNotRollback(ServiceHandleException):
    def __init__(self):
        super(ErrAppUpgradeRecordCanNotRollback, self).__init__("can not rollback the record",
                                                                msg_show="无法回滚该记录",
                                                                status_code=400,
                                                                error_code=20907)
...
class ErrAppUpgradeWrongStatus(ServiceHandleException):
    def __init__(self):
        super(ErrAppUpgradeWrongStatus, self).__init__("the status of the upgrade record is not not_upgraded",
                                                       msg_show="只能升级未升级的升级记录",
                                                       status_code=400,
                                                       error_code=20908)
