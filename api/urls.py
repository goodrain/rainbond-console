...
from api.views.tenants.services import TenantServiceStaticsView, TenantHibernateView, TenantCloseRestartView, TenantView, AllTenantView, TenantSystemHibernateView
...
urlpatterns = patterns(
    ...
    url(r'^tenants/services/system-hibernate$', TenantSystemHibernateView.as_view()),
