...
a = Analysis(['console_app.py'],
             ...
             hiddenimports=['gunicorn.glogging', 'gunicorn.workers.sync', 'django.core.cache.backends.memcached', 'django.core.context_processors', 'django.core.mail.backends.smtp', 'django.views.defaults'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
