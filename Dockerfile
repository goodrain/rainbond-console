...
ARG RAINBOND_POSTHOG_PROJECT_TOKEN=phc_oCoPwcxutKCU9AZtUT63dMTNhWezUxCXCLtSZE6a4wvE
ARG RAINBOND_POSTHOG_API_HOST=https://posthog.goodrain.com
...
ENV RAINBOND_POSTHOG_PROJECT_TOKEN=${RAINBOND_POSTHOG_PROJECT_TOKEN}
