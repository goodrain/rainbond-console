...
class RegionConfig(BaseModel):
    ...
    url = models.CharField(max_length=256, help_text=u"数据中心url")
    token = models.CharField(max_length=1024,null=True, blank=True, default="", help_text=u"数据中心token")
    status = models.CharField(max_length=32, help_text=u"数据中心状态 0：编辑中 1:启用 2：停用")
    create_time = models.DateTimeField(auto_now_add=True, blank=True, help_text=u"创建时间")
...
class Announcement(BaseModel):
    ...
    a_tag = models.CharField(max_length=256, default="", help_text=u"A标签文字")
    a_tag_url = models.CharField(max_length=1024, default="", help_text=u"a标签跳转地址")
    type = models.CharField(max_length=15, default="all", help_text=u"通知类型")
