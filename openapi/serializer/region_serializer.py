...
class RegionInfoRespSerializer(serializers.Serializer):
    ...
    total_memory = serializers.IntegerField(help_text=u"调度内存总和MB", allow_blank=True, allow_null=True)
    used_memory = serializers.IntegerField(help_text=u"调度内存使用量MB", allow_blank=True, allow_null=True)
    total_cpu = serializers.IntegerField(help_text=u"调度CPU总和", allow_blank=True, allow_null=True)
    used_cpu = serializers.IntegerField(help_text=u"调度CPU使用量", allow_blank=True, allow_null=True)
    total_disk = serializers.IntegerField(help_text=u"全局共享存储总量GB", allow_blank=True, allow_null=True)
    used_disk = serializers.IntegerField(help_text=u"全局共享存储使用量GB", allow_blank=True, allow_null=True)
