...
| console.realtime-proxy.multipart-upload-forward | 实时代理流式转发离线应用上传请求 | active | regression | console.utils.realtime_proxy._should_forward_raw_multipart | console/tests/realtime_proxy_url_test.py::RealtimeProxyUrlTests.test_app_import_upload_forwards_raw_multipart_body |
...
| console.region.default-initialization | 默认数据中心初始化支持跨数据库后端 | active | regression | scripts.init_default_region.initialize_default_region | console/tests/default_region_init_test.py::DefaultRegionInitializerTest |
...
- 测试类型: `unit`
- 接口类型: `workflow`
- 业务入口: `entrypoint.sh database readiness workflow`
- 代码路径: `entrypoint.sh`, `scripts/database_state.py`
- 测试路径: `console/tests/database_state_test.py::DatabaseStateTests`

### 准备私有达梦 Python 驱动包

- Capability ID: `console.database.dm-driver-bundle-preparation`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
...
- 代码路径: `console/syncservice/create_default_group.py`, `console/syncservice/sync_manage.py`, `console/repositories/app.py`, `console/repositories/app_config.py`, `console/repositories/enterprise_repo.py`, `console/repositories/plugin/plugin.py`, `console/repositories/service_repo.py`, `console/repositories/share_repo.py`, `console/repositories/team_repo.py`, `console/repositories/tenant_region_repo.py`, `console/repositories/user_role_repo.py`, `console/repositories/user_repo.py`, `console/services/app_config/domain_service.py`, `console/services/app_config/plugin_service.py`, `console/services/service_services.py`, `console/services/plugin/app_plugin.py`, `console/services/market_app_service.py`, `console/views/app_config/app_domain.py`, `console/views/app_config/app_env.py`, `console/views/public_areas.py`, `console/utils/database.py`, `openapi/views/enterprise_view.py`, `openapi/v2/views/enterprise_view.py`, `www/db/service_group_repository.py`, `www/services/plugin.py`
...
- 测试类型: `unit`
- 接口类型: `other`
- 业务入口: `goodrain_web.settings.DATABASES`
- 代码路径: `goodrain_web/settings.py`
- 测试路径: `console/tests/database_settings_test.py::DatabaseSettingsTests`

### 标准控制台镜像内置达梦驱动

- Capability ID: `console.database.dm-standard-image`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
...
- Capability ID: `console.deploy-diagnostics.offline-mode`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
- 业务入口: `console.services.enterprise_first_deploy_service.EnterpriseFirstDeployService`
- 代码路径: `console/services/enterprise_first_deploy_service.py`, `console/utils/offline.py`
- 测试路径: `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_does_not_start_report_sweeper`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_online_mode_starts_report_sweeper`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_skips_report_request`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_does_not_create_deploy_tracking`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_does_not_persist_source_check_failure`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_marks_first_deploy_report_handled_without_thread`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_removes_unreported_deploy_attempt`, `console/tests/enterprise_first_deploy_service_test.py::EnterpriseFirstDeployServiceTests.test_offline_mode_forgets_unpersisted_report`
...
- 代码路径: `console/services/market_app_service.py`
- 测试路径: `console/tests/market_app_service_test.py::MarketAppServiceOfflineUpgradeTests`
...
- 测试类型: `regression`
- 接口类型: `package_function`
- 业务入口: `console.utils.realtime_proxy._should_forward_raw_multipart`
- 代码路径: `console/utils/realtime_proxy.py`
- 测试路径: `console/tests/realtime_proxy_url_test.py::RealtimeProxyUrlTests.test_app_import_upload_forwards_raw_multipart_body`
...
- Capability ID: `console.region.default-initialization`
- 状态: `active`
- 测试类型: `regression`
- 接口类型: `workflow`
- 业务入口: `scripts.init_default_region.initialize_default_region`
- 代码路径: `scripts/init_default_region.py`, `entrypoint.sh`
- 测试路径: `console/tests/default_region_init_test.py::DefaultRegionInitializerTest`
