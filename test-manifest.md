...
| rainbond-console.vm-run.disk-asset-create | 从现有磁盘资产的源地址创建虚拟机 | active | regression | console.views.app_create.vm_run.VMRunCreateView.post | console/tests/vm_asset_instantiation_test.py::VMAssetInstantiationTests::test_vm_run_create_from_existing_disk_asset_uses_source_uri_for_vm_build |
