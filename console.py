...
STREAM_DOMAIN_URL = {"cloudbang": "10.80.86.19"}

WILD_DOMAINS = {"cloudbang": ".<domain>"}

WILD_PORTS = {"cloudbang": "80"}
...
APP_SERVICE_API = {'url': 'http://app.goodrain.com:80', 'apitype': 'app service'}

REGION_RULE = {
    'dev': {
        'personal_money': 0.069,
        'company_money': 0.276,
        'personal_month_money': 50,
...
0uZ0qXkoe2t0KFr_3cKfsYyG7F--QniyVElkjp6UJTBqXFU5E88easFVqA4YP9ARCGdbc\
xlp3ga6rfMq1KlRPv3G73hN4diUvcoP_0aOLbD7v17cuWWRXTfIcP5d1JuDTOHc0z-lGjw\
VQj4iJesBS1QaD5YpgrsJXzKAvI01'

# log domain
LOG_DOMAIN = {"cloudbang": "auto"}
